  ...
  <div class="flex justify-center items-center">
    <div class="w-full mx-5">
      <div class="flex flex-col w-full flex-grow relative">
        ...
        {:else}
        <button class="absolute md:right-3 md:bottom-[1rem] right-2 bottom-[0.845rem] text-white font-bold rounded-full border-2 border-gray-900 p-1 dark:border-gray-200" on:click|preventDefault={stopChat}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="h-2 w-2 text-gray-900 dark:text-gray-200" viewBox="0 0 16 16">
